...
<title>Aquent Test Crud App - Add a Contact</title>
	...
	<div class="row" id="content">
		<div class="medium-8 columns">
			...
			<div class="blog-post">
				...
				<form action="${pageContext.request.contextPath}/person/create"
					method="POST">
					...
					<div class="row">
						<div class="medium-6 columns">
							...
							<label for="firstName">First Name</label> <input id="firstName"
								type="text" name="firstName" placeholder="" value=""
								minlength="2" maxlength="50" required />
						</div>
						<div class="medium-6 columns">
							<label for="lastName">Last Name</label> <input id="lastName"
								type="text" name="lastName" placeholder="" value=""
								minlength="2" maxlength="50" required />
						</div>
					...
					<div class="row">
						<div class="medium-12 columns">
							<label for="emailAddress">Email</label> <input id="emailAddress"
								type="email" name="emailAddress" placeholder="" value=""
								minlength="2" maxlength="50" required />
						</div>
					...
					<div class="row">
						<div class="medium-12 columns">
							<label for="streetAddress">Street Address</label> <input
								...
								placeholder="" value="" minlength="2" maxlength="50" required />
						</div>
					...
					<div class="row">
						<div class="medium-7 columns">
							<label for="city">City</label> <input id="city" type="text"
								name="city" placeholder="" value="" minlength="2" maxlength="50"
								required />
						</div>
						<div class="medium-2 columns">
							<label for="state">State</label> <input id="state" type="text"
								name="state" placeholder="" value="" minlength="2" maxlength="2"
								required />
						</div>

						<div class="medium-3 columns">
							<label for="zipCode">Zip</label> <input id="zipCode" type="text"
								name="zipCode" placeholder="" value="" minlength="5"
					...
					<label for="clientId">Client</label> <select id="clientId"
						...
						<c:forEach items="${clientsAll}" var="associatedClient">
							<option value="${associatedClient.clientId}">${associatedClient.companyName}</option>
						</c:forEach>
