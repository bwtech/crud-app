...
<title>Aquent Test Crud App - Edit Client</title>
				...
				<p>
					...
					<form:form id="editForm"
						...
						<div class="row">
							...
							<div class="medium-6 columns">
								<label for="contactsToRemove">Select existing contacts to
									remove from this client:</label>
								<form:select id="contactsToRemove" path="contactsToRemove"
									multiple="true" width="100">
									<form:options items="${client.contacts}" itemValue="personId"
										itemLabel="lastNameAndFirstName" />
								</form:select>
							</div>
						</div>
